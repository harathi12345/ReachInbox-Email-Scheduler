...
const Schedule = () => {
  ...
  useEffect(() => {
    fetchEmails().then(setEmails).catch(() => setError("Unable to load scheduled campaigns.")).finally(() => setLoading(false));
  }, []);
