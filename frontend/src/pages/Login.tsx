  ...
  return (
    <AuthShell>
      <form className="auth-card" onSubmit={submit}>
        ...
        <p className="section-label mt-10">Welcome back</p>
        <h1 className="mt-2 text-2xl font-bold text-white">Sign in to your workspace</h1>
        <p className="mt-2 text-sm text-slate-500">Manage your email delivery pipeline.</p>
